...
<img src="https://skillicons.dev/icons?i=js,ts,python,java,cpp,rust,cs,php,latex,react,threejs,nextjs,tailwind,figma,vite,ps,ai,ae,pr,nodejs,flutter,express,nestjs,fastapi,laravel,mongodb,postgres,mysql,redis,firebase,supabase,gcp,aws,azure,docker,cloudflare,git,tensorflow,pytorch,opencv,sklearn,gitlab,postman,spring,kotlin" />
